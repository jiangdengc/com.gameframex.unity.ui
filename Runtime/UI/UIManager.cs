...
namespace GameFrameX.UI.Runtime
{
    ...
    internal sealed partial class UIManager : GameFrameworkModule, IUIManager
    {
        ...
        public Task<int> OpenUIFormAsync(string uiFormAssetName, string uiGroupName)
        {
            return OpenUIFormAsync(uiFormAssetName, uiGroupName, false, null);
        }
        ...
        /// <returns>界面的序列编号。</returns>
        public Task<int> OpenUIFormAsync(string uiFormAssetName, string uiGroupName, bool pauseCoveredUIForm)
        {
            return OpenUIFormAsync(uiFormAssetName, uiGroupName, pauseCoveredUIForm, null);
        }
        ...
        /// <returns>界面的序列编号。</returns>
        public async Task<int> OpenUIFormAsync(string uiFormAssetName, string uiGroupName, object userData)
        {
            return await OpenUIFormAsync(uiFormAssetName, uiGroupName, false, userData);
        }
        ...
        /// <param name="userData">用户自定义数据。</param>
        /// <returns>界面的序列编号。</returns>
        public async Task<int> OpenUIFormAsync(string uiFormAssetName, string uiGroupName, bool pauseCoveredUIForm, object userData)
        {
            ...
            if (uiFormInstanceObject == null)
            {
                ...
                {
                    LoadAssetSuccessCallback(uiFormAssetName, assetHandle.InstantiateAsync(), assetHandle.Progress, OpenUIFormInfo.Create(serialId, uiGroup, pauseCoveredUIForm, userData));
                }
                else
                {
                    LoadAssetFailureCallback(uiFormAssetName, assetHandle.LastError, OpenUIFormInfo.Create(serialId, uiGroup, pauseCoveredUIForm, userData));
                }
            }
            else
            {
